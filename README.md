# Awesome Berlin Datenjournalismus [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of outstanding data journalism projects about Berlin

A collection of the most interesting and impactful data journalism projects focused on Berlin - from interactive maps and neighborhood analyses to investigative data stories about the German capital.

## Contents

- [Stadtentwicklung & Wohnen](#stadtentwicklung--wohnen)
...
- [Kriminalität & Sicherheit](#kriminalität--sicherheit)

## Stadtentwicklung & Wohnen

Projects about housing, rent, urban development and neighborhoods.

## Verkehr & Mobilität

Projects about transportation, cycling, public transit and traffic.

## Bildung & Soziales

Projects about schools, education, demographics and social issues.

### 🎓 [Alle Berliner Schulen im Vergleich 2025: An welchen Schulen gibt es die besten Abiturnoten?](https://interaktiv.tagesspiegel.de/lab/alle-berliner-schulen-im-vergleich-2025-an-welchen-schulen-gibt-es-die-besten-abiturnoten-interaktive-karte/)

**November 2025 · Der Tagesspiegel**
...
Projects about Berlin's history, architecture and cultural heritage.

### ✈️ [Der BER im 3D-Modell: Deswegen wurde 14 Jahre lang gebaut](https://interaktiv.tagesspiegel.de/lab/flughafen-ber-in-3d/)

**Oktober 2020 · Der Tagesspiegel**

Interaktive 3D-Scroll-Story erklärt die Baufiaskos des Flughafens BER: vom "Monster" (Entrauchungsanlage) über 14.750 Brandschutzmängel bis zu falsch verlegten Kabeln. WebGL-Modell macht Architektur und Planungsfehler räumlich erlebbar. Inklusive Zukunftsprognosen und Vergleich mit europäischen Flughäfen. Entwickelt mit Vragments/Scrollmersive.
